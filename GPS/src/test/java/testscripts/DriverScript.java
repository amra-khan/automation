...
public class DriverScript {
	...
	fs = new FileInputStream(System.getProperty("user.dir")
		+ "\\src\\test\\java\\config\\app_text.properties");
	APPTEXT.load(fs);
