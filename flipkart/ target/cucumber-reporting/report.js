$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("CustomerCare.feature");
formatter.feature({
  "line": 3,
  "name": "Customer Care Page",
  "description": "",
  "id": "customer-care-page",
  "keyword": "Feature",
  "tags": [
    {
      "line": 2,
...
formatter.scenario({
  ...
  "description": "",
  "id": "customer-care-page;customer-support-helpline",
  "type": "scenario",
  "keyword": "Scenario",
  "tags": [
    {
...
formatter.step({
  "line": 8,
  "name": "User clicks on Customer Care link",
  "keyword": "When "
});
formatter.step({
  "line": 9,
  "name": "he should see the customer Care page",
  "keyword": "Then "
});
formatter.match({});
formatter.result({
...
formatter.match({
  "location": "TestCase.user_clicks_on_Customer_Care_link()"
});
formatter.result({
  "status": "skipped"
});
formatter.match({
  "location": "TestCase.he_should_see_the_customer_Care_page()"
});
formatter.result({
  "status": "skipped"
});
formatter.scenario({
  ...
  "description": "",
  "id": "customer-care-page;customer-care-issues",
  "type": "scenario",
  "keyword": "Scenario",
  "tags": [
    {
...
formatter.step({
  "line": 13,
  "name": "User clicks on each issue",
  "keyword": "When "
});
formatter.step({
  "line": 14,
  "name": "clicks on view more",
  "keyword": "And "
});
formatter.step({
  "line": 15,
  "name": "user should be able to count number of questions",
  "keyword": "Then "
});
formatter.match({
  "location": "TestCase.user_clicks_on_each_issue()"
});
formatter.result({
  "duration": 181821634,
  "error_message": "java.lang.NullPointerException\r\n\tat pageObjects.CustomerCare.clickEachIssue(CustomerCare.java:42)\r\n\tat stepDefinitions.TestCase.user_clicks_on_each_issue(TestCase.java:114)\r\n\tat ✽.When User clicks on each issue(CustomerCare.feature:13)\r\n",
  "status": "failed"
});
formatter.match({});
formatter.result({
...
formatter.scenario({
  ...
  "description": "",
  "id": "home-page;login-into-flipkart",
  "type": "scenario",
  "keyword": "Scenario",
  "tags": [
    {
...
formatter.result({
  "duration": 4651405,
  "error_message": "java.lang.NullPointerException\r\n\tat org.openqa.selenium.support.pagefactory.DefaultElementLocator.findElement(DefaultElementLocator.java:69)\r\n\tat org.openqa.selenium.support.pagefactory.internal.LocatingElementHandler.invoke(LocatingElementHandler.java:38)\r\n\tat com.sun.proxy.$Proxy15.click(Unknown Source)\r\n\tat pageObjects.HomePage.openLoginWindow(HomePage.java:35)\r\n\tat stepDefinitions.TestCase.he_clicks_on_login_icon(TestCase.java:28)\r\n\tat ✽.When he clicks on login icon(HomePage.feature:7)\r\n",
  "status": "failed"
});
formatter.match({
